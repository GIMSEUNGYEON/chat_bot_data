...
def create_look_ahead_mask(x):
    ...
    padding_mask = mask[:, tf.newaxis, tf.newaxis, :] # 패딩 마스크도 포함
...
class MyModel:
    def __init__(self):
        ...
        self.model.fit(dataset, epochs=100)
        self.model.summary()
        # self.model.save("chatbot_sem.h5")
        save_model(self.model, "chatbot_data2.h5", overwrite=True, include_optimizer=True)
